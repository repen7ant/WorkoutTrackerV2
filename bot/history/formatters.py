from bot.catalog.api import ExerciseInfo
from bot.common.formatting import format_set_lines
from bot.workouts.domain import LoggedWorkout


def format_workout_detail(
    workout: LoggedWorkout, exercises: dict[int, ExerciseInfo]
) -> str:
    ...
    for ex in workout.exercises:
        lines.append(f"<b>{exercises[ex.exercise_id].name}</b>")
